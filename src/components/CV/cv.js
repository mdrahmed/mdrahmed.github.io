    ...
    <div className='resume-section'>
        <Container fluid className="resume-section">
            ...
            <Row style={{ justifyContent: "center", position: "relative", paddingTop: "20px" }}>
                <p>Here is my <strong class="purple"><a href="https://www.overleaf.com/project/66f731d2ecbca9896f15e5b1" target="_blank" class="purple-link">LaTex Resume template</a></strong></p>
            </Row>
        </Container>
    </div>
  );
